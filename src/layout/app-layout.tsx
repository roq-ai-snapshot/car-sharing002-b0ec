...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Files', icon: FiFile, path: '/files', entity: RoqResourceEnum.FILE },
  { name: 'booking', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'car', path: '/cars', entity: 'car', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'company', path: '/companies', entity: 'company', service: AccessServiceEnum.PROJECT, icon: FiHome },
